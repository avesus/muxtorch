...
class one_layer_net(torch.nn.Module):    
    ...
    def __init__(self, input_size, hidden_neurons, output_size):
        ...
        torch.nn.init.xavier_uniform_(self.linear_one.weight)
        torch.nn.init.xavier_uniform_(self.linear_two.weight)
...
# create the model 
model = one_layer_net(1, 5, 1)  # 2 represents two neurons in one hidden layer
